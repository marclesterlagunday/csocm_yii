    ...
    <div class="thumbnail">
                    ...
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            <h4 class="group inner list-group-item-heading"><b>
                                <?php echo $data->Classes->Subject->description /*. " ( " . $data->Room->description . " ) */; ?>
                            </b></h4>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <a class="btn btn-success btn-block" ref=<?php echo $data->Classes->class_id; ?> href="<?php echo Yii::app()->createUrl( "class/view&id=" ) . $data->Classes->class_id; ?>" >View</a>
            </div>
        </div>
    </div>
</div>