...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2016 at 10:03 AM
...
INSERT INTO `attendance` (`attendance_id`, `date`, `class`, `saved_by`, `saved_date`, `status`) VALUES
(1, '2016-10-06', 1, 12, '2016-10-06 07:49:47', 0);
...
INSERT INTO `attendance_student` (`attendance_student_id`, `attendance`, `student`, `present`) VALUES
(1, 1, 10, 0),
(2, 1, 11, 0),
(3, 1, 13, 0);
...
INSERT INTO `classes` (`class_id`, `title`, `subject`, `room`, `sy`, `semester`, `instructor`, `time_start`, `time_end`, `date_created`, `date_ended`, `created_by`) VALUES
(1, 'Biology - RM 101 ( 10:00 AM - 12:00 PM )', 2, 1, 3, 0, 12, '10:00:00', '12:00:00', '2016-09-10 03:43:52', '0000-00-00 00:00:00', 1),
(2, 'Geometry - RM 102 ( 04:15 PM - 05:15 PM )', 1, 2, 1, 0, 12, '04:15:00', '05:15:00', '2016-09-27 10:04:29', '0000-00-00 00:00:00', 1),
(3, 'Biology - RM 101 ( 09:15 PM - 10:15 PM )', 2, 1, 1, 0, 12, '09:15:00', '10:15:00', '2016-10-05 15:13:39', '0000-00-00 00:00:00', 1);
...
--
-- Table structure for table `class_standings`
--

CREATE TABLE IF NOT EXISTS `class_standings` (
`id` int(11) NOT NULL,
  `class` int(11) NOT NULL,
  `student` int(11) NOT NULL,
  `type` int(11) NOT NULL,
...
--
-- Dumping data for table `class_standings`
--

INSERT INTO `class_standings` (`id`, `class`, `student`, `type`, `Grade`) VALUES
(1, 3, 10, 1, 90),
(2, 3, 10, 3, 80),
(3, 3, 10, 4, 75);
...
--
-- Table structure for table `class_standing_type`
--

CREATE TABLE IF NOT EXISTS `class_standing_type` (
`id` int(11) NOT NULL,
  `description` varchar(128) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `class_standing_type`
--

INSERT INTO `class_standing_type` (`id`, `description`) VALUES
(1, 'Quizzes'),
(2, 'Project'),
(3, 'Prelims I'),
(4, 'Prelims II'),
...
(1, 'Photosynthesis', 'Description', 'Photosynthesis.pdf', '0000-00-00 00:00:00', 0);
...
CREATE TABLE IF NOT EXISTS `lib_lecture` (
...
(13, 'user', '$2a$13$zt5VP..1zFeNdgp2xDSnpei2rMxoYpcq55Vir/FTaTYzKA3KXiQd6', 'boey6172@gmail.com', '', 'daniel', 'meynard', 'mabunga', 23, 1, '123456789'),
(14, 'usert', '$2a$13$rtM2aRTfrAgG3uVriR6iTODHVD.sf2FMNn4XZEecP0j2nR9WsD.kK', 'boey6172@gmail.com', '', 'daniel', 'meynard', 'mabunga', 23, 1, '123457899');
...
ALTER TABLE `attendance_student`
 ADD PRIMARY KEY (`attendance_student_id`);
...
--
-- Indexes for table `class_standings`
--
ALTER TABLE `class_standings`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `class_standing_type`
--
ALTER TABLE `class_standing_type`
 ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `attendance_student`
MODIFY `attendance_student_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `class_days`
MODIFY `class_day_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `class_lecture`
--
ALTER TABLE `class_lecture`
MODIFY `class_lecture_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `class_standings`
--
ALTER TABLE `class_standings`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `class_standing_type`
--
ALTER TABLE `class_standing_type`
