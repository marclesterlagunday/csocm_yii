...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2016 at 02:32 AM
...
INSERT INTO `announcement` (`announcement_id`, `title`, `message`, `posted_by`, `defined_class`, `posted_date_time`) VALUES
(7, 'No Classes Today', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 12, 2, '2016-09-09 21:28:48');
...
(4, 2, 1, 3, 0, 12, '08:30:00', '10:30:00', '2016-09-10 02:20:36', '0000-00-00 00:00:00', 1);
...
(10, 'Photosynthesis', 'Food Plant', 'Photosynthesis.pdf', '0000-00-00 00:00:00', 0);
...
--
ALTER TABLE `class_days`
MODIFY `class_day_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `class_lecture`
--
ALTER TABLE `class_lecture`
MODIFY `class_lecture_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `class_student`
--
ALTER TABLE `class_student`
MODIFY `class_student_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
